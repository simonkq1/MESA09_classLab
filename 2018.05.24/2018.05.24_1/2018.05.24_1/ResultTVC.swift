...
class ResultTVC: UITableViewController,UISearchResultsUpdating {
    ...
    var filterList: [[String:String]]?  //搜尋後
    var jsonObject: [[String:Any]] = []
    var list: [[String:String]] = []    //全部資料
...
//                    print(o["county"])
//                    print(searchText)
//                    if o["county"] as! String == searchText{
//
//                    }
//                }
//            }
            filterList = list.filter({ (a) -> Bool in
                return a["County"]?.range(of: searchText) != nil
            })
    ...
    override func viewDidLoad() {
        ...
        list = app.uviData.getJsonObject() as! [[String:String]]
