...
//        linePath.getOneControlPoint(
//            x0: xPosition[i - 1] + ((xPosition[i] - xPosition[i - 1]) / 2),
//            y0: yPosition[i - 1] + ((yPosition[i] - yPosition[i - 1]) / 2),
//            x1: xPosition[i],
//            y1: yPosition[i],
//            x2: xPosition[i] + ((xPosition[i + 1] - xPosition[i]) / 2),
//            y2: yPosition[i] + ((yPosition[i + 1] - yPosition[i]) / 2))
//
//                linePath.getTwoControlPoint(
//                    x0: xPosition[0],
//                    y0: yPosition[0],
